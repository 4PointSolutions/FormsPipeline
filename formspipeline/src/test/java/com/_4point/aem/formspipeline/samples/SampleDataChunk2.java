...
public class SampleDataChunk2 implements DataChunk<SampleDataContext2> {
	public static final String DATA_PAYLOAD = "SampleDataContext2 Payload";
	public static final String CONTEXT_KEY = "SampleKey2";
	public static final String CONTEXT_VALUE = "SampleValue2";
	private final SampleDataContext2 contextInstance = new SampleDataContext2();
	
	public class SampleDataContext2 implements Context {
