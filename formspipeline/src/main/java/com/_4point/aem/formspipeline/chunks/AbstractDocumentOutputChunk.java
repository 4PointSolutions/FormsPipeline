...
public sealed abstract class AbstractDocumentOutputChunk <D extends Context, U extends Context> 
					   extends AbstractInMemoryChunkImpl 
					   implements OutputChunk<D, U>  
					   permits PclOutputChunk, PdfOutputChunk, PsOutputChunk 
					   {
