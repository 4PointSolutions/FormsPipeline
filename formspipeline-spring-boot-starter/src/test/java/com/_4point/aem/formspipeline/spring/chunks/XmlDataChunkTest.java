...
class XmlDataChunkTest {
	...
	//Helper method
	private XmlDataContextImpl getXmlDataContext(String xmlFileName) {
    	...
    	XmlDataContextImpl xmlDataContext = XmlDataChunk.XmlDataContextImpl.initializeXmlDoc(xmlStream);
    ...
    void testInitializeXmlDoc_throwException() {
		...
		assertThrows( XmlDataException.class, () -> {
			XmlDataChunk.XmlDataContextImpl.initializeXmlDoc(xmlStream);
	    });
    }
    ...
    void testDataContext() {    	
    	...
    	XmlDataChunk underTest = XmlDataChunk.create(xmlBytes);
    ...
    void testGetString_complexXml_FoundRepeatItemUsingIndex_returnValue()throws Exception {
    	XmlDataContextImpl underTest = getXmlDataContext(TestHelper.COMPLEX_XML_DATA_FILE);	        
    ...
    void testGetString_simpleXML_throwException()throws Exception {
    	XmlDataContextImpl underTest = getXmlDataContext(TestHelper.SIMPLE_XML_DATA_FILE);
    ...
    void testGetString_complexXML_FoundRepeatItem_ChineseCharacter_returnValue()throws Exception {
    	...
    	XmlDataContextImpl underTest = getXmlDataContext(TestHelper.COMPLEX_XML_DATA_FILE_ASIAN);		
